...
export const SCENARIOS: ScenarioConfig[] = [
  {
    ...
    visualStyle: "late-night office live broadcast, desk glow, candid documentary meme still",
  ...
  },
  {
    ...
    defaultCaptions: ["오늘의 직관 주인공", "카메라에 잡힌 순간", "응원력 최대치", "전광판 데뷔 완료"],
  ...
  },
  {
    ...
    defaultCaptions: ["속보: 오늘도 버팀", "현장 연결합니다", "평온한 척하는 중", "별일 아닌데 긴급"],
    visualStyle: "fictional breaking news studio, lower thirds, serious parody broadcast frame",
  ...
  },
  {
    ...
    defaultCaptions: ["오늘의 착장 입장", "플래시 감당 중", "출근룩인데 시상식", "표정 관리 완료"],
    visualStyle: "red carpet press photo, flash lighting, celebrity entrance parody",
    recommendedMode: "broadcast_2x2",
  },
  {
    id: "f1-pitwall",
    ...
    defaultCaptions: ["월요일 전략 회의", "멘탈 피트인 필요", "일정 추월 금지", "오늘도 완주"],
  ...
  },
  {
    ...
    visualStyle: "airline seat map infographic, playful character variants, comment-bait meme layout",
  ...
  },
  {
    ...
    defaultCaptions: ["문제지 첫 장", "기억 로딩 중", "찍신 대기 중", "살아서 나옴"],
    visualStyle: "classroom tension documentary still, exam survival meme frame",
    recommendedMode: "broadcast_2x2",
  },
  {
    ...
    defaultCaptions: ["집까지 23분", "이어폰 장착 완료", "오늘의 엔딩 크레딧", "무사 귀환"],
    visualStyle: "commute documentary still, subway or street lights, tired but heroic mood",
    recommendedMode: "broadcast_2x2",
  },
];
